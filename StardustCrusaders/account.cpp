...
void account::getStats(){
    ...
    if(!file_to_check_existance){ //Se il file non esiste è perché l'utente non ha ancora mai giocato
        ...
        while (file_to_check_existance >> games >> type >> num_hit >> num_miss){
    ...
    cout << "\n\n\n";
    cout << "\t\t\t\t\t\t\t\t Il numero di partite vinte in modalità multigiocatore e' \033[1;35m" << n_vic_Vs_H << "\033[0m" << endl;
    cout << "\n\n\n";
    ...
    cout << "\t\t\t\t\t\t\t\t Il numero di partite vinte contro il computer e' \033[1;35m" << n_vic_Vs_C << "\033[0m" << endl;
    cout << "\n\n\n";
    ...
    cout << "\t\t\t\t\t\t\t\t La tua precisione e' pari al \033[1;35m" << main << "%" << "\033[0m";
        cin.ignore();
    }
    system("clear");
}
